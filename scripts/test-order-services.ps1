...
try {
    ...
    node --conditions=react-server -r ts-node/register --test tests/orders.integration.test.ts tests/access.integration.test.ts tests/integration-events.test.ts tests/mercadolivre.test.ts tests/sebo.test.ts tests/oauth.test.ts tests/reconciliation.test.ts tests/messaging.test.ts tests/catalog.test.ts tests/categories.test.ts tests/ml-catalog.test.ts tests/listing-attributes.test.ts tests/shopee.test.ts tests/olx.test.ts tests/facebook.test.ts tests/tenant-isolation.test.ts tests/organization-profile.test.ts tests/marketplace-config.test.ts tests/event-history.test.ts
