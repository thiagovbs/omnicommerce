...
try {
    ...
    node --conditions=react-server -r ts-node/register --test tests/orders.integration.test.ts tests/access.integration.test.ts tests/integration-events.test.ts tests/mercadolivre.test.ts tests/messaging.test.ts
