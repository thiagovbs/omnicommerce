        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b">
              <tr>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold">Data</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold">Marketplace</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold">Pedido</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold">Produtos</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold text-right">Líquido (Net)</th>
              ...
              {allSales.length > 0 ? (
                allSales.map((sale) => (
                  <tr key={sale.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 sm:px-6 sm:py-4 text-sm">{sale.marketplace.name}</td>
                    <td className="px-4 py-3 sm:px-6 sm:py-4 text-sm">
                    ...
                    <td className="px-4 py-3 sm:px-6 sm:py-4 text-sm text-right font-bold text-green-700">
