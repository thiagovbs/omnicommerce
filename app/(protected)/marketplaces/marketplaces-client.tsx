          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-200">
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold text-gray-900">Nome</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold text-gray-900">Provedor</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold text-gray-900">Configuração</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold text-gray-900">Status</th>
                <th className="px-4 py-3 sm:px-6 sm:py-4 text-sm font-semibold text-gray-900 text-right">Ações</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {initialData.map((mp) => (
                <tr key={mp.id} className="hover:bg-gray-50/50 transition-colors group">
                  <td className="px-4 py-3 sm:px-6 sm:py-4 text-sm text-gray-900 font-medium">{mp.name}</td>
                  ...
                  <td className="px-4 py-3 sm:px-6 sm:py-4 text-right flex justify-end gap-2">
